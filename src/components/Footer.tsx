      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div className="animate-fade-in [animation-delay:100ms]">
            <h4 className="text-xl font-bold mb-4">Sādhak</h4>
          ...
          <div className="animate-fade-in [animation-delay:200ms]">
            ...
            <ul className="space-y-2">
              {[
                ...
                { name: t.nav.bookNow, path: "/contact" },
              ].map((link) => (
                <li key={link.name}>
                  <Link 
                    to={link.path} 
          ...
          <div className="animate-fade-in [animation-delay:300ms]">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-muted-foreground">+91 9909948117</span>
              </li>
              <li className="flex items-center">
                <Mail className="w-5 h-5 mr-2 text-primary" />
                <span className="text-muted-foreground">info@sadhak.co</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-border pt-8 mt-8 text-center text-muted-foreground">
          <p>&copy; {currentYear} Sādhak. {t.footer.allRights}</p>
        </div>
      </div>
    </footer>
  );
